...
package com.alumnuscircle.myself.rvcircle;
...
public class CircleAdapter extends RecyclerView.Adapter<CircleAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.me_item_circle,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Load_HeadPortrait(holder.circleImg,
                circleItemList.get(position).getCircleImgUrl());
...
//    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        CircleNetworkImage circleImg;
        TextView circleName;


        public MyViewHolder(View itemView) {
            super(itemView);
            circleImg=(CircleNetworkImage) itemView.findViewById(R.id.me_item_circleImg);
