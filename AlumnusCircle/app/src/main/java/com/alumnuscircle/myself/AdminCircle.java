 ...
 */
public class AdminCircle extends Fragment {
    ...
    private RecyclerView rvAdminCircle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.me_admin_circle, container, false);
    ...
    private void initRecycleView() {
        rvAdminCircle.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvAdminCircle.setAdapter(adapter = new CircleAdapter(getActivity(), data));
...
//                DividerItemDecoration.VERTICAL_LIST));
    ...
    private void initView(View view){
        rvAdminCircle=(RecyclerView)view.findViewById(R.id.rv_admin_circle);
    }
