...
class CircleModule(BaseModule):
    ...
    def set_circle_info(self,umeng_cid,umeng_virtual_cid,circle_type_id,icon_url):
        ...
        c_id = self.db.insert("INSERT INTO " + self._circle_table + "( " + self._umeng_cid +" , "+
            self._umeng_virtual_cid + " , " + self._circle_type_id + " , " + self._icon_url 
            + " ) " + "VALUES (%s,%s,%s,%s)",
            umeng_cid,umeng_virtual_cid,circle_type_id,icon_url)
        return c_id
