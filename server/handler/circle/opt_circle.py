...
class LeaveCircleHandler(TopicHandler):
    ...
    def post(self):
        ...
        # admin_circle_list = 
        create_circle_list = self.user_detail_module.get_create_circle_list(uid)
        ...
        self.user_detail_module.leave_circle(string_my_circle_list,string_create_circle_list,uid)
